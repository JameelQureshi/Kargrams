...
namespace ARLocation.UI
{
    public class DebugDistance : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            ////textMesh.text = "fareeeee : "+Vector3.Distance(startPos, endPos).ToString("0.00", CultureInfo.InvariantCulture) + "m";
            //Dist = Vector3.Distance(startPos, endPos);
            //if (Dist < 10.0f)
            //{
            //    // if you change the distance here then you have to change the distance in ARItem.
            //    ARLinksPanel.instance.Animated_Panel.SetActive(true);
            //    ARLinksPanel.instance.Animated_Model.SetActive(true);
            //    ARLinksPanel.instance.Animated_Button.SetActive(true);
            //    ARLinksPanel.instance.check = true;
            //}
        }
    }
